...
export const PACKAGES = [
  {
    ...
    storyPosition: '68% 42%',
    inclusions: [
      { icon: 'water', title: '1 bottle of mineral water (1L) per person' },
      { icon: 'coffee', title: 'One-time tea/coffee with cookies and one hot snack' },
      { icon: 'beach', title: 'Exclusive beach access' },
      { icon: 'bath', title: 'Wash and change facilities' },
      { icon: 'sports', title: 'Water sports available on a chargeable basis' },
    ],
    story: {
  ...
  },
  {
    ...
    storyPosition: '48% 62%',
    inclusions: [
      { icon: 'parking', title: 'Pick-up and drop from parking' },
      { icon: 'water', title: '1 L mineral water, tea and cookies' },
      { icon: 'beach', title: 'Exclusive beach access with wash and change' },
      { icon: 'snack', title: 'One hot snack' },
      { icon: 'therapy', title: 'Sand bath and mud therapy' },
      { icon: 'walk', title: 'Guided marine / beach walk' },
      { icon: 'meals', title: 'Veg lunch and evening hi-tea' },
      { icon: 'sports', title: 'Water sports available on a chargeable basis' },
    ],
    story: {
  ...
  },
  {
    ...
    storyPosition: '70% 80%',
    inclusions: [
      { icon: 'car', title: 'Pick-up by AC car' },
      { icon: 'water', title: '1 L mineral water, tea and cookies' },
      { icon: 'temple', title: 'Temple darshan with guide and prasad' },
      { icon: 'temple', title: 'Hanuman Dandi Temple' },
      { icon: 'ticket', title: 'Golden Dwarka Museum ticket' },
    ],
    story: {
